...
local useMotion = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "Utility", "Hooks", "use-motion.hook").default
local useTheme = TS.import(script, script.Parent.Parent.Parent.Parent.Parent, "Utility", "Hooks", "use-theme.hook").default
